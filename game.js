...
(function () {
  ...
  function revealCards() {
    ...
    mutate(function (s) {
      s.winnerTeam = winner ? Number(winner.teamId) : null; s.winnerCard = winner ? Number(winner.card) : null; s.winnerSkill = winner && winner.useSkill ? winner.mascotId : null; s.timerEnd = null; s.phase = winner ? "reveal" : "result"; s.autoAt = Date.now() + (winner ? 1900 : 2500);
  ...
  function grade(correct) {
    ...
    mutate(function (s) {
      ...
      s.phase = "result"; s.timerEnd = null; s.autoAt = Date.now() + 3000;
